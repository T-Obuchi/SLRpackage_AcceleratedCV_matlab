...
# DESCRIPTION
Compute a solution path with respect to amplitude parameter
...
<img src="https://latex.codecogs.com/gif.latex?\hat{\bm{\beta}}={\rm&space;argmin}_{\bm{\beta}}\left(&space;(1/2)||Y-X\bm{\beta}||_2^2&space;&plus;&space;\sum_{i}^{N}J(\beta_i;\eta)&space;\right)" />
